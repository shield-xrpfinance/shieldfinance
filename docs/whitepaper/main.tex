...
\begin{tabular}{rl}
    ...
    \textbf{dApp} & shyield.finance/app \\[0.3em]
...
Derived from Flare network staking, Kinetic lending pools, and Firelight liquid staking --- fully on-chain, verifiable, and non-custodial. Sources: FlareScan\textsuperscript{[1]}, kinetic.markets\textsuperscript{[2]}, firelight.finance\textsuperscript{[3]}.
...
\quad $\bullet$ Firelight stXRP (early data) & $\approx$ 6.0--8.5\% (firelight.finance\textsuperscript{[3]}) \\
...
Test it now: \texttt{shyield.finance/app}
\end{tcolorbox}
...
\midrule
Asfalia & Complete (Nov 2025) & Full smart contract audit (asfaliasecurity.com/project/shield-finance) \\
...
Nov 2025 & XRPL Smart Accounts & Gasless Flare transactions via XRPL memo encoding (LIVE) \\
...
\textbf{XRPL Smart Accounts (NOW LIVE):} Execute Flare smart contract transactions directly from your XRPL wallet using encoded memo instructions. No EVM wallet required. No gas fees. Powered by Flare Data Connector (FDC) for trustless cross-chain verification. Available to all users connecting with Xaman or other XRPL wallets.
\end{tcolorbox}
...
{\color{textgray} Website: shyield.finance \quad | \quad dApp: shyield.finance/app \quad | \quad Twitter: @ShieldFinanceX}
...
\midrule
Asfalia & Complete (November 2025) & asfaliasecurity.com/project/shield-finance \\
...
\textbf{Geographic Restrictions.} Front-end access to shyield.finance/app is restricted for UAE IP addresses pending VASP licensing. Users bear sole responsibility for ensuring compliance with local regulations. Smart contract interactions remain permissionless per blockchain design.
...
{[3]} & Firelight Liquid Staking --- \texttt{firelight.finance} \\
