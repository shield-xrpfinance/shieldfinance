...
\subsection*{Key Facts \normalfont\small(Testnet \& Projected Metrics --- live data at app.shyield.finance)}
...
\centering
\textbf{$\blacktriangleright$ Testnet is LIVE --- earn OG airdrop points now: app.shyield.finance}\\[0.3em]
Get testnet tokens: faucet.shyield.finance
\end{tcolorbox}
