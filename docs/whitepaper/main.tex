%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Shield Finance Whitepaper v1.3 – December 2025 (Mainnet Edition)
...
\fancyhead[R]{\small\color{textgray}Whitepaper v1.3 --- December 2025 (Mainnet Edition)}
...
{\large\color{shieldblue} Version 1.3 --- December 2025 (Mainnet Edition)}
...
100\% fair-launch on Flare mainnet --- December 2025.}
...
\subsection*{Current Mainnet-Relevant Metrics \normalfont\small(28 Nov 2025 --- live data at app.shyield.finance)}
...
Security & Hacken audit complete\textsuperscript{[4]} $\cdot$ Trail of Bits Q1 2026 \\
\bottomrule
\end{tabular}
\end{center}
...
\centering
\textbf{$\blacktriangleright$ Mainnet LIVE --- start earning yield now: app.shyield.finance}\\[0.3em]
Documentation: docs.shyield.finance
\end{tcolorbox}
...
{\footnotesize APY ranges based on publicly verifiable on-chain data as of December 2025. Sources cited in References.}
...
\midrule
ShieldToken & \texttt{TBD --- Mainnet deployment December 2025} \\
RevenueRouter & \texttt{TBD --- Mainnet deployment December 2025} \\
StakingBoost & \texttt{TBD --- Mainnet deployment December 2025} \\
ShXRPVault & \texttt{TBD --- Mainnet deployment December 2025} \\
\bottomrule
\end{tabular}
\end{center}
...
{\footnotesize Testnet contracts (Coston2) available for review: ShieldToken \texttt{0x061...616}, RevenueRouter \texttt{0x262...fFB}, StakingBoost \texttt{0xC7C...2B4}, ShXRPVault \texttt{0xeBb...90e}}
...
\midrule
Hacken\textsuperscript{[4]} & Complete (December 2025) & hacken.io/audits/shield-finance \\
...
{[4]} & Hacken Security Audit (December 2025) --- \texttt{hacken.io/audits/shield-finance} \\
...
{\footnotesize Whitepaper v1.3 accurate as of December 2025. Repository: \texttt{github.com/shield-xrpfinance/shieldfinance}}
...
{\color{textgray} December 2025 --- Version 1.3 (Mainnet Edition)}
