...
\fancyhead[R]{\small\color{textgray}Whitepaper v1.1 --- December 2025}
\fancyfoot[L]{\footnotesize\color{shieldblue}\textit{Turning the world's most efficient payment asset into the highest-yielding liquid one.}}
...
{\large\color{shieldblue} Version 1.1}
...
\subsection*{Key Facts \normalfont\small(Live \& Historical data --- updated daily at app.shyield.finance/stats)}
...
Security Audits & Hacken (in progress), Trail of Bits (Q1 2026), CertiK (Q2 2026) \\
\bottomrule
\end{tabular}
\end{center}
...
{\footnotesize *All APY figures are 30-day trailing averages as of 01 Dec 2025. Base APY derived from Flare inflation + FAssets rewards. Boost APY scales with \% of SHIELD locked vs vault TVL. Past performance $\neq$ future results.}

\vspace{0.3em}

{\footnotesize See living tokenomics: \texttt{github.com/shield-xrpfinance/shieldfinance/blob/main/docs/protocol/SHIELD\_TOKENOMICS.md}}
...
% Center node
\node[box, fill=shieldblue, text=white, minimum width=2.8cm] (revenue) {Revenue\\{\scriptsize 0.4\% fees}};
...
\begin{tcolorbox}[
    ...
    top=8pt,
    bottom=8pt,
    title={\textbf{Reserves Breakdown (10\% of protocol fees)}}
]
\begin{itemize}
    \item \textbf{50\%} $\rightarrow$ Security \& Audits (Hacken, Trail of Bits, CertiK, bug bounties)
...
\end{itemize}
\vspace{0.3em}
{\footnotesize Governance-approved; full transparency at \texttt{github.com/shield-xrpfinance/shieldfinance/docs/protocol/SHIELD\_TOKENOMICS.md}}
\end{tcolorbox}
...
CertiK & Planned Q2 2026 & Full protocol \& economic audit \\
...
{\footnotesize Detailed treasury allocation and boost mechanics maintained in repository (commit-synced with this whitepaper v1.1).}
...
{\footnotesize Whitepaper v1.1 synchronized with repository commit \texttt{8f3a9c2} (08 Dec 2025).}
...
{\color{textgray} December 2025 --- Version 1.1}
