...
export interface IShieldToken$Type {
  readonly _format: "hh3-artifact-1";
  readonly contractName: "IShieldToken";
  readonly sourceName: "contracts/interfaces/IShieldToken.sol";
  ...
  readonly inputSourceName: "project/contracts/interfaces/IShieldToken.sol";
...
declare module "hardhat/types/artifacts" {
  interface ArtifactMap {
    ["IShieldToken"]: IShieldToken$Type;
    ["contracts/interfaces/IShieldToken.sol:IShieldToken"]: IShieldToken$Type;
  }
}