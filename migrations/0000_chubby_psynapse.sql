CREATE TYPE "public"."bridge_status" AS ENUM('pending', 'bridging', 'awaiting_payment', 'xrpl_confirmed', 'generating_proof', 'fdc_timeout', 'proof_generated', 'fdc_proof_generated', 'minting', 'vault_minting', 'vault_minted', 'completed', 'vault_mint_failed', 'cancelled', 'failed');--> statement-breakpoint
CREATE TYPE "public"."redemption_status" AS ENUM('pending', 'redeeming_shares', 'redeemed_fxrp', 'redeeming_fxrp', 'awaiting_proof', 'xrpl_payout', 'completed', 'awaiting_liquidity', 'failed');--> statement-breakpoint
