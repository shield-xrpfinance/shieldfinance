                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="p-3 rounded-lg bg-muted/50 border">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <p className="font-mono font-bold text-sm truncate" data-testid="text-referral-link">
                          {`${window.location.origin}?ref=${userPointsData.referralCode}`}
                        </p>
                        <Button 
                          variant="ghost" 
                          size="sm"
                          onClick={() => {
                            navigator.clipboard.writeText(`${window.location.origin}?ref=${userPointsData.referralCode}`);
                            toast({
                              title: "Copied!",
                    ...
                    <p className="text-xs text-center text-muted-foreground">
                      {userPointsData.referralCount || 0} friends joined using your link
                    </p>
                  </CardContent>
                </Card>
              )}
